// Package is not implemented by the etcd backend stub.
package etcd
...
// New constructs the etcd backend stub without opening a connection.
//
// Parameters:
...
// RegisterRelay is not implemented by the etcd backend stub.
//
// Parameters:
...
// HeartbeatRelay is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
...
// ListRelays is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
//
...
// RemoveRelay is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
//   - relayID: identifies the target relay.
...
// RegisterAgent is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
...
// HeartbeatAgent is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
...
// GetAgentPlacement is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
//   - agentID: identifies the target agent.
...
// ListAgents is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
//
...
// ListRelayAgents is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
//   - relayID: identifies the target relay.
...
// RemoveAgents is not implemented by the etcd backend stub.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
...
// Close is a no-op because the etcd backend stub owns no resources.
//
// Parameters:
//   - ctx: controls cancellation and deadlines for the operation.
//
