...
var (
	...
	ErrTTLConformanceInvalid      = errors.New("conformance projection ttl must be > 0")
	ErrTTLConformanceFenceInvalid = errors.New("conformance fence ttl must exceed projection ttl")
